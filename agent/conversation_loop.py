            ...
            if agent.provider == "nous":
                try:
                    ...
                    if _nous_remaining is not None and _nous_remaining > 0:
                        ...
                        # No reason on purpose: rate_limit would arm the
                        # escalating primary cooldown in try_activate_fallback
                        # on every turn of the Nous window, benching the
                        # primary long after the Nous reset.
